      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30">
        ...
        <section className="w-full mb-8" aria-label="San Pablo City Hero Banner">
          <div className="text-center -mt-8">
            {/* Added a priority prop to signal that the first banner image is the LCP element */}
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            {articles.length === 0 ? (
              <div className="text-center py-12">
                <Newspaper className="w-16 h-16 text-gray-300 mx-auto mb-4" aria-hidden="true" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Improved Accessibility: Added aria-label for better link description */}
                <Link 
                  href="/services" 
