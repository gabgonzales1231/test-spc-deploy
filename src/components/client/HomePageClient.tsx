    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30">
        ...
        <section id="news" className="py-8 bg-gradient-to-r from-emerald-50 to-white mt-8" aria-labelledby="news-heading">
          <div className="max-w-7xl mx-auto px-4">
            <header className="text-center mb-16">
              ...
              {/* Increased contrast: emerald-600 -> emerald-700 */}
              <p className="text-xl text-emerald-700 font-medium">Stay informed with the latest developments and initiatives</p>
            </header>
            {articles.length === 0 ? (
              <div className="text-center py-12">
                <Newspaper className="w-16 h-16 text-gray-400 mx-auto mb-4" aria-hidden="true" />
                {/* Increased contrast: gray-500 -> gray-700 */}
        ...
        <section id="services" className="py-10 bg-gradient-to-b from-white to-emerald-50/30" aria-labelledby="services-heading">
          <div className="max-w-7xl mx-auto px-4">
            <div>
              <h3 id="services-heading" className="text-2xl font-bold text-gray-900 mb-6 text-center">Available Services</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                  ...
                  {/* Increased contrast: gray-600 -> gray-700 */}
                  <p className="text-gray-700 text-sm mb-6 flex-grow">Discover additional services available to you.</p>
            ...
            <div className="bg-gradient-to-r from-emerald-700 to-emerald-800 rounded-xl p-4 sm:p-6 shadow-lg mt-12">
              ...
              <div className="flex flex-col lg:hidden gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://e.gov.ph" target="_blank" rel="noopener noreferrer"
                    ...
                    aria-label="Visit the official eGov Philippines website (opens in new tab)">
                    <span>Website</span>
                    <ArrowRight className="w-4 h-4 flex-shrink-0" />
                  </a>
                </div>
                <p className="text-white text-xs sm:text-sm leading-relaxed px-2 font-medium">Access integrated government services in one platform. Complete transactions anytime, anywhere.</p>
              ...
              <div className="hidden lg:flex items-center justify-between gap-6">
                ...
                <div className="text-white flex-1 text-center md:text-left">
                  <p className="text-sm leading-relaxed font-medium">Access integrated government services in one platform. Complete transactions anytime, anywhere.</p>
                </div>
                <nav className="flex flex-wrap gap-2 justify-end flex-shrink-0" aria-label="eGov PH platform links">
                  <a href="https://e.gov.ph" target="_blank" rel="noopener noreferrer"
                    ...
                    aria-label="Visit the official eGov Philippines website"><span>Website</span></a>
                  <a href="https://play.google.com/store/apps/details?id=egov.app&hl=en_US" target="_blank" rel="noopener noreferrer"
